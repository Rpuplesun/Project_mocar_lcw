	...
	<div class="container border bg-primary bg-opacity-75 rounded"
		...
		<div class="row py-5 ">
			...
			<div class="col-3 text-center">
				...
				<p class="mt-2">
					<a href="#" class="text-decoration-none text-white"
						data-bs-toggle="modal" data-bs-target="#mileage">마일리지</a>
				</p>
			</div>
			<div class="col-3 text-center">
				<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"
				...
				<p class="mt-2">
					<a href="#" class="text-decoration-none text-white"
						data-bs-toggle="modal" data-bs-target="#reserve">예약현황</a>
				</p>
			</div>
		</div>
						...
						<form class="">
							...
							<div class="form-floating mb-3 row"
								...
								<button type="button" class="btn btn-primary col-3"
									style='margin-left: 20px;'>변경</button>
							</div>
